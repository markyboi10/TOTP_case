 ...
 * @author Mark Case
 */
public class PassResponse implements Packet, JSONSerializable {
        
    // Packet Type
    private static final PacketType PACKET_TYPE = PacketType.PassResponse;
     ...
     * @param msg
     */
    public PassResponse(boolean msg) {
        this.msg = msg;
    }
